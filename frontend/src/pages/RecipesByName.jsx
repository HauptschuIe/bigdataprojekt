...
/**
 * This is the class component that displays the recipe search page in the app
 *
 * @author [Lukas Rutkauskas] (https://github.com/LukasRutkauskas)
 */

class RecipesByName extends Component {
  constructor(props) {
    super(props);
  ...
  makeApiCall = (searchInput) => {
    var searchUrl = `http://34.107.94.7:5000/Chefkoch%20API/recipes-by-name/${this.state.searchValue}`;
    fetch(searchUrl)
      .then((response) => {
...
//Styling of all of the components
...
export default withStyles(styles)(RecipesByName);
