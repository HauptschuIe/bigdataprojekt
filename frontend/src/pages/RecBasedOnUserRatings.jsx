...
class RecBasedOnUserRatings extends Component {
  constructor(props) {
    super(props);
  ...
  makeApiCall = (searchInput) => {
    var searchUrl = `http://34.107.94.7:5000/Chefkoch%20API/see-what-other-users-rated/${this.state.searchValue}`;
    fetch(searchUrl)
      .then((response) => {
...
export default withStyles(styles)(RecBasedOnUserRatings);
