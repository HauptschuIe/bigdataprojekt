...
class RecBasedOnIngredients extends Component {
  constructor(props) {
    super(props);
  ...
  makeApiCall = (searchInput) => {
    var searchUrl = `http://34.107.94.7:5000/Chefkoch%20API/similar-recipes-based-on-ingredients-and-keywords/${this.state.searchValue}`;
    fetch(searchUrl)
      .then((response) => {
...
export default withStyles(styles)(RecBasedOnIngredients);
